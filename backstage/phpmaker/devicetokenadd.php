...
$devicetoken_add = NULL; // Initialize page object first

class cdevicetoken_add extends cdevicetoken {
	...
	// Page object name
	var $PageObjName = 'devicetoken_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // ' Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "devicetokenview.php")
	...
	function LoadDefaultValues() {
		$this->devicetoken->CurrentValue = NULL;
		$this->devicetoken->OldValue = $this->devicetoken->CurrentValue;
		$this->devicename->CurrentValue = NULL;
		$this->devicename->OldValue = $this->devicename->CurrentValue;
		$this->deviceplatform->CurrentValue = NULL;
		$this->deviceplatform->OldValue = $this->deviceplatform->CurrentValue;
		$this->deviceuuid->CurrentValue = NULL;
		$this->deviceuuid->OldValue = $this->deviceuuid->CurrentValue;
		$this->deviceversion->CurrentValue = NULL;
		$this->deviceversion->OldValue = $this->deviceversion->CurrentValue;
	...
	function AddRow($rsold = NULL) {
		...
		// devicetoken
		$this->devicetoken->SetDbValueDef($rsnew, $this->devicetoken->CurrentValue, "", FALSE);

		// devicename
		$this->devicename->SetDbValueDef($rsnew, $this->devicename->CurrentValue, "", FALSE);

		// deviceplatform
		$this->deviceplatform->SetDbValueDef($rsnew, $this->deviceplatform->CurrentValue, "", FALSE);

		// deviceuuid
		$this->deviceuuid->SetDbValueDef($rsnew, $this->deviceuuid->CurrentValue, "", FALSE);

		// deviceversion
		$this->deviceversion->SetDbValueDef($rsnew, $this->deviceversion->CurrentValue, "", FALSE);
...
// Create page object
if (!isset($devicetoken_add)) $devicetoken_add = new cdevicetoken_add();

// Page init
$devicetoken_add->Page_Init();

// Page main
$devicetoken_add->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var devicetoken_add = new ew_Page("devicetoken_add");
devicetoken_add.PageID = "add"; // Page ID
var EW_PAGE_ID = devicetoken_add.PageID; // For backward compatibility

// Form object
var fdevicetokenadd = new ew_Form("fdevicetokenadd");

// Validate form
fdevicetokenadd.Validate = function(fobj) {
...
fdevicetokenadd.Form_CustomValidate =  
...
fdevicetokenadd.ValidateRequired = true;
<?php } else { ?>
fdevicetokenadd.ValidateRequired = false; 
<?php } ?>
...
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $devicetoken->TableCaption() ?></span></p>
<p class="phpmaker"><a href="<?php echo $devicetoken->getReturnUrl() ?>"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $devicetoken_add->ShowPageHeader(); ?>
<?php
$devicetoken_add->ShowMessage();
?>
<form name="fdevicetokenadd" id="fdevicetokenadd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<p>
<input type="hidden" name="t" value="devicetoken">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_devicetokenadd" class="ewTable">
...
<script type="text/javascript">
fdevicetokenadd.Init();
</script>
<?php
$devicetoken_add->ShowPageFooter();
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
?>
<script type="text/javascript">
...
<?php
$devicetoken_add->Page_Terminate();
?>
