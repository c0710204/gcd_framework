...
$classtime_add = NULL; // Initialize page object first

class cclasstime_add extends cclasstime {
		...
		switch ($this->CurrentAction) {
			...
			case "A": // ' Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "classtimeview.php")
	...
	function LoadDefaultValues() {
		$this->classroomId->CurrentValue = NULL;
		$this->classroomId->OldValue = $this->classroomId->CurrentValue;
		$this->date->CurrentValue = NULL;
		$this->date->OldValue = $this->date->CurrentValue;
		$this->courseId1->CurrentValue = NULL;
		$this->courseId1->OldValue = $this->courseId1->CurrentValue;
		$this->courseId2->CurrentValue = NULL;
		$this->courseId2->OldValue = $this->courseId2->CurrentValue;
		$this->courseId3->CurrentValue = NULL;
		$this->courseId3->OldValue = $this->courseId3->CurrentValue;
		$this->courseId4->CurrentValue = NULL;
		$this->courseId4->OldValue = $this->courseId4->CurrentValue;
		$this->courseId5->CurrentValue = NULL;
		$this->courseId5->OldValue = $this->courseId5->CurrentValue;
		$this->courseId6->CurrentValue = NULL;
		$this->courseId6->OldValue = $this->courseId6->CurrentValue;
		$this->courseId7->CurrentValue = NULL;
		$this->courseId7->OldValue = $this->courseId7->CurrentValue;
		$this->courseId8->CurrentValue = NULL;
		$this->courseId8->OldValue = $this->courseId8->CurrentValue;
		$this->courseId9->CurrentValue = NULL;
		$this->courseId9->OldValue = $this->courseId9->CurrentValue;
		$this->courseId10->CurrentValue = NULL;
		$this->courseId10->OldValue = $this->courseId10->CurrentValue;
		$this->courseId11->CurrentValue = NULL;
		$this->courseId11->OldValue = $this->courseId11->CurrentValue;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// classroomId
		$this->classroomId->SetDbValueDef($rsnew, $this->classroomId->CurrentValue, NULL, FALSE);

		// date
		$this->date->SetDbValueDef($rsnew, ew_UnFormatDateTime($this->date->CurrentValue, 5), NULL, FALSE);

		// courseId1
		$this->courseId1->SetDbValueDef($rsnew, $this->courseId1->CurrentValue, NULL, FALSE);

		// courseId2
		$this->courseId2->SetDbValueDef($rsnew, $this->courseId2->CurrentValue, NULL, FALSE);

		// courseId3
		$this->courseId3->SetDbValueDef($rsnew, $this->courseId3->CurrentValue, NULL, FALSE);

		// courseId4
		$this->courseId4->SetDbValueDef($rsnew, $this->courseId4->CurrentValue, NULL, FALSE);

		// courseId5
		$this->courseId5->SetDbValueDef($rsnew, $this->courseId5->CurrentValue, NULL, FALSE);

		// courseId6
		$this->courseId6->SetDbValueDef($rsnew, $this->courseId6->CurrentValue, NULL, FALSE);

		// courseId7
		$this->courseId7->SetDbValueDef($rsnew, $this->courseId7->CurrentValue, NULL, FALSE);

		// courseId8
		$this->courseId8->SetDbValueDef($rsnew, $this->courseId8->CurrentValue, NULL, FALSE);

		// courseId9
		$this->courseId9->SetDbValueDef($rsnew, $this->courseId9->CurrentValue, NULL, FALSE);

		// courseId10
		$this->courseId10->SetDbValueDef($rsnew, $this->courseId10->CurrentValue, NULL, FALSE);

		// courseId11
		$this->courseId11->SetDbValueDef($rsnew, $this->courseId11->CurrentValue, NULL, FALSE);
...
// Create page object
if (!isset($classtime_add)) $classtime_add = new cclasstime_add();

// Page init
$classtime_add->Page_Init();

// Page main
$classtime_add->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var classtime_add = new ew_Page("classtime_add");
classtime_add.PageID = "add"; // Page ID
var EW_PAGE_ID = classtime_add.PageID; // For backward compatibility

// Form object
var fclasstimeadd = new ew_Form("fclasstimeadd");

// Validate form
fclasstimeadd.Validate = function(fobj) {
...
fclasstimeadd.Form_CustomValidate =  
...
fclasstimeadd.ValidateRequired = true;
<?php } else { ?>
fclasstimeadd.ValidateRequired = false; 
<?php } ?>
...
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $classtime->TableCaption() ?></span></p>
<p class="phpmaker"><a href="<?php echo $classtime->getReturnUrl() ?>"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $classtime_add->ShowPageHeader(); ?>
<?php
$classtime_add->ShowMessage();
?>
<form name="fclasstimeadd" id="fclasstimeadd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<p>
<input type="hidden" name="t" value="classtime">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_classtimeadd" class="ewTable">
