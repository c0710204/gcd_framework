...
//
// Table class for album
//
class calbum extends cTable {
	var $id;
	var $title;
	var $intro;
	var $path;
	...
	function __construct() {
		...
		// id
		$this->id = new cField('album', 'album', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// title
		$this->title = new cField('album', 'album', 'x_title', 'title', '`title`', '`title`', 200, -1, FALSE, '`title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['title'] = &$this->title;

		// intro
		$this->intro = new cField('album', 'album', 'x_intro', 'intro', '`intro`', '`intro`', 201, -1, FALSE, '`intro`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['intro'] = &$this->intro;

		// path
		$this->path = new cField('album', 'album', 'x_path', 'path', '`path`', '`path`', 200, -1, FALSE, '`path`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['path'] = &$this->path;

		// filename
		$this->filename = new cField('album', 'album', 'x_filename', 'filename', '`filename`', '`filename`', 200, -1, FALSE, '`filename`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['filename'] = &$this->filename;

		// typeid
		$this->typeid = new cField('album', 'album', 'x_typeid', 'typeid', '`typeid`', '`typeid`', 3, -1, FALSE, '`typeid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->typeid->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['typeid'] = &$this->typeid;

		// publish
		$this->publish = new cField('album', 'album', 'x_publish', 'publish', '`publish`', 'DATE_FORMAT(`publish`, \'%Y/%m/%d %H:%i:%s\')', 135, 5, FALSE, '`publish`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("albumview.php", $this->UrlParm());
	}
	...
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("albumedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("albumadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("albumdelete.php", $this->UrlParm());
	}
