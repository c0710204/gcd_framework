...
define("EW_PROJECT_NAME", "iBistu", TRUE); // Project name
define("EW_CONFIG_FILE_FOLDER", EW_PROJECT_NAME . "", TRUE); // Config file name
define("EW_PROJECT_ID", "{0FEB9E42-0859-45AD-84C6-C2CDD4EB41BE}", TRUE); // Project ID (GUID)
$EW_RELATED_PROJECT_ID = "";
$EW_RELATED_LANGUAGE_FOLDER = "";
define("EW_RANDOM_KEY", 'BkzcA3puGXHCRZsp', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "phpcss/iBistu.css", TRUE); // Project stylesheet file name
...
define("EW_CONN_USER", 'ibistu', TRUE);
define("EW_CONN_PASS", 'bistu!@#2012', TRUE);
define("EW_CONN_DB", 'ibistu', TRUE);
