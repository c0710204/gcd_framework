...
$courselist_add = NULL; // Initialize page object first

class ccourselist_add extends ccourselist {
	...
	// Page object name
	var $PageObjName = 'courselist_add';
		...
		switch ($this->CurrentAction) {
			...
			case "A": // ' Add new record
				...
				if ($this->AddRow($this->OldRecordset)) { // Add successful
					...
					if (ew_GetPageName($sReturnUrl) == "courselistview.php")
	...
	function LoadDefaultValues() {
		...
		$this->majorId->CurrentValue = NULL;
		$this->majorId->OldValue = $this->majorId->CurrentValue;
	}
	...
	function AddRow($rsold = NULL) {
		...
		// courseCode
		$this->courseCode->SetDbValueDef($rsnew, $this->courseCode->CurrentValue, "", FALSE);

		// courseName
		$this->courseName->SetDbValueDef($rsnew, $this->courseName->CurrentValue, "", FALSE);

		// majorId
		$this->majorId->SetDbValueDef($rsnew, $this->majorId->CurrentValue, 0, FALSE);
...
// Create page object
if (!isset($courselist_add)) $courselist_add = new ccourselist_add();

// Page init
$courselist_add->Page_Init();

// Page main
$courselist_add->Page_Main();
?>
<?php include_once "header.php" ?>
<script type="text/javascript">

// Page object
var courselist_add = new ew_Page("courselist_add");
courselist_add.PageID = "add"; // Page ID
var EW_PAGE_ID = courselist_add.PageID; // For backward compatibility

// Form object
var fcourselistadd = new ew_Form("fcourselistadd");

// Validate form
fcourselistadd.Validate = function(fobj) {
...
fcourselistadd.Form_CustomValidate =  
...
fcourselistadd.ValidateRequired = true;
<?php } else { ?>
fcourselistadd.ValidateRequired = false; 
<?php } ?>
...
<p><span class="ewTitle ewTableTitle"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $courselist->TableCaption() ?></span></p>
<p class="phpmaker"><a href="<?php echo $courselist->getReturnUrl() ?>"><?php echo $Language->Phrase("GoBack") ?></a></p>
<?php $courselist_add->ShowPageHeader(); ?>
<?php
$courselist_add->ShowMessage();
?>
<form name="fcourselistadd" id="fcourselistadd" class="ewForm" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return ewForms[this.id].Submit();">
<p>
<input type="hidden" name="t" value="courselist">
<input type="hidden" name="a_add" id="a_add" value="A">
<table cellspacing="0" class="ewGrid"><tr><td class="ewGridContent">
<div class="ewGridMiddlePanel">
<table cellspacing="0" id="tbl_courselistadd" class="ewTable">
