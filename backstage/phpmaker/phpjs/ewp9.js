...
function ew_MultiPage(formid) {
	...
	// if ASP.NET 
//	if (ewLang.isFunction(Page_ClientValidate)) {
//    var Original_Page_ClientValidate = Page_ClientValidate; 
//		Page_ClientValidate = function() { 
//			var isValid = Original_Page_ClientValidate();          
//			if (!isValid) 
