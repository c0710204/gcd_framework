...
//
class cactivity extends cTable {
	var $id;
	var $title;
	var $intro;
	var $tel;
	...
	function __construct() {
		...
		// id
		$this->id = new cField('activity', 'activity', 'x_id', 'id', '`id`', '`id`', 3, -1, FALSE, '`id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] = &$this->id;

		// title
		$this->title = new cField('activity', 'activity', 'x_title', 'title', '`title`', '`title`', 200, -1, FALSE, '`title`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['title'] = &$this->title;

		// intro
		$this->intro = new cField('activity', 'activity', 'x_intro', 'intro', '`intro`', '`intro`', 201, -1, FALSE, '`intro`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['intro'] = &$this->intro;

		// tel
		$this->tel = new cField('activity', 'activity', 'x_tel', 'tel', '`tel`', '`tel`', 200, -1, FALSE, '`tel`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['tel'] = &$this->tel;

		// website
		$this->website = new cField('activity', 'activity', 'x_website', 'website', '`website`', '`website`', 200, -1, FALSE, '`website`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
		$this->fields['website'] = &$this->website;

		// typeid
		$this->typeid = new cField('activity', 'activity', 'x_typeid', 'typeid', '`typeid`', '`typeid`', 3, -1, FALSE, '`typeid`', FALSE, FALSE, FALSE, 'FORMATTED TEXT');
	...
	// View URL
	function GetViewUrl() {
		return $this->KeyUrl("activityview.php", $this->UrlParm());
	}

	// Add URL
	function GetAddUrl() {
		return "activityadd.php";
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		return $this->KeyUrl("activityedit.php", $this->UrlParm($parm));
	}
	...
	function GetCopyUrl($parm = "") {
		return $this->KeyUrl("activityadd.php", $this->UrlParm($parm));
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("activitydelete.php", $this->UrlParm());
	}
